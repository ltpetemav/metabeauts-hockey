...
const lesson2Steps: TutorialStep[] = [
  ...
  },
  {
    ...
    lesson: 2,
    stepIndex: 6,
    dialogue: "You drew Skate! That's a rush up ice — you keep the puck and push forward. Now the defense picks their counter card. They SEE what you drew and CHOOSE deliberately.",
  ...
  },
  {
    ...
    lesson: 2,
    stepIndex: 7,
    dialogue: "Defense plays Steal... but Steal only stops Pass! Your Skate blows right past it. Offense keeps the puck.",
    waitFor: 'auto',
    autoAdvanceMs: 2000,
