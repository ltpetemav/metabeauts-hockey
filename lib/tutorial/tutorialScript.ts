...
const lesson2Steps: TutorialStep[] = [
  ...
  },
  {
    ...
    lesson: 2,
    stepIndex: 7,
    dialogue: "Defense guessed wrong and played Steal... but Steal only stops Pass! Your Skate blows right past it. That's the blind read in action.",
    waitFor: 'auto',
    autoAdvanceMs: 2000,
...
const lesson3Steps: TutorialStep[] = [
  ...
  },
  {
    ...
    lesson: 3,
    stepIndex: 2,
    dialogue: "Defense picked Check blind — but Check only stops Skate! Your Pass goes right through. Resolve it!",
    spotlight: 'tutorial-resolve-btn',
    waitFor: 'click-spotlight',
    phase: 'SIMULTANEOUS_REVEAL',
  },
  ...
  },
  {
    ...
    lesson: 3,
    stepIndex: 5,
    dialogue: "Defense guessed Steal — bad read! Steal only stops Pass. Your Shoot goes right through. Resolve it!",
    spotlight: 'tutorial-resolve-btn',
    waitFor: 'click-spotlight',
    phase: 'SIMULTANEOUS_REVEAL',
  },
